...
class programa():
    ...
    def editar(self):
        ...
        self.editar_frame = ctk.CTkFrame(master=janela, width=350, height=396)
        self.editar_frame.pack(side=ctk.RIGHT)
    ...
    def tela_opcao(self):
        ...
        btn_vercliente.place(x=25, y=170)
        ...
        btn_emprestimo.place(x=25, y=210)
        ...
        btn_verEmprestimo.place(x=25, y=250)

        btn_excluir = ctk.CTkButton(self.opcao_frame, text="Excluir", font=self.font_btn,command=self.excluir, height=35, width=304)
        btn_excluir.place(x=25, y=290)
        
        btn_editar = ctk.CTkButton(self.opcao_frame, text="Editar", font=self.font_btn,command=self.editar, height=35, width=304)
        btn_editar.place(x=25, y=330)
